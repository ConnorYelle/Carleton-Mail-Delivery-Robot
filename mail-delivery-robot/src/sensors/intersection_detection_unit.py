...
class IntersectionDetectionUnit(Node):
    ...
    def __init__(self):
        ...
        self.intersection_detection_publisher = self.create_publisher(
            String, "intersection_detection", 10
        )
        self.intersection_detection_timer = self.create_timer(
            0.5, self.update_intersection_detection
        )
    ...
    def lidar_data_callback(self, data):
        ...
        if (
            (split_data[2] == "-1" and split_data[3] == "-1")
