...
class MusicPlayer(Node):
    def __init__(self):
        ...
        note_a_very_low_half = AudioNote(
            frequency=freq_a_very_low, max_runtime=dur_half
        )
        note_b_very_low_half = AudioNote(
            frequency=freq_b_very_low, max_runtime=dur_half
        )
        note_c_very_low_half = AudioNote(
            frequency=freq_c_very_low, max_runtime=dur_half
        )
        note_d_very_low_half = AudioNote(
            frequency=freq_d_very_low, max_runtime=dur_half
        )
        note_e_very_low_half = AudioNote(
            frequency=freq_e_very_low, max_runtime=dur_half
        )
        note_f_very_low_half = AudioNote(
            frequency=freq_f_very_low, max_runtime=dur_half
        )
        note_g_very_low_half = AudioNote(
            frequency=freq_g_very_low, max_runtime=dur_half
        )
        ...
        note_a_very_low_quarter = AudioNote(
            frequency=freq_a_very_low, max_runtime=dur_quarter
        )
        note_b_very_low_quarter = AudioNote(
            frequency=freq_b_very_low, max_runtime=dur_quarter
        )
        note_c_very_low_quarter = AudioNote(
            frequency=freq_c_very_low, max_runtime=dur_quarter
        )
        note_d_very_low_quarter = AudioNote(
            frequency=freq_d_very_low, max_runtime=dur_quarter
        )
        note_e_very_low_quarter = AudioNote(
            frequency=freq_e_very_low, max_runtime=dur_quarter
        )
        note_f_very_low_quarter = AudioNote(
            frequency=freq_f_very_low, max_runtime=dur_quarter
        )
        note_g_very_low_quarter = AudioNote(
            frequency=freq_g_very_low, max_runtime=dur_quarter
        )
